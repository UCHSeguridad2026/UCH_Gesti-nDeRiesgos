...
* **Nombre completo:** Tomas Serrani
* **LU:** 31954584
* **Email institucional:** tomasserrani7@gmail.com
* **Comisión:** C1

## Despliegue del Entorno
1. Ir a la carpeta `entorno/`.
2. Ejecutar `docker-compose up -d`.
3. Acceder en el navegador a `http://localhost:8080`.

## Decisiones de Diseño y Verificación
Se adoptó una matriz cualitativa 5x5 acorde al contexto de la clínica. 
