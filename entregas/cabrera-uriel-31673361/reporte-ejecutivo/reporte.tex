...
de acción totalizan \textbf{USD 32.500}, distribuidos en seis meses. Dos de los
cuatro riesgos críticos se atienden con USD 5.000 combinados, de modo que una
parte sustancial de la exposición puede reducirse con el 15\,\% del presupuesto.
\end{enumerate}
...
\subsection*{1. Aprobar de inmediato los dos planes de menor costo sobre riesgos críticos}

PA02 y PA04 suman USD 5.000 --- el 15\,\% del presupuesto total --- y atienden
dos de los cuatro riesgos de nivel Crítico. Ambos se resuelven con controles de
procedimiento antes que con inversión tecnológica, por lo que ofrecen la mayor
reducción de riesgo por unidad de inversión de todo el plan. No existe argumento
económico para postergarlos.
